## 1. Reference case for the tutorial
The tutorial uses as a reference case, the model developed to assess the **cost-effectiveness** of adding **Biotinidase Deficiency (BD) newborn screening (NBS)** to the national NBS program in Spain, as described by [Vallejo-Torres et al. (2015)](https://pubmed.ncbi.nlm.nih.gov/26169436/). The analysis takes the perspective of the **Spanish National Health Service (NHS)**, using **Quality-Adjusted Life Years (QALYs)** as the measure of effectiveness. 

### 1.1. Biotinidase deficiency
